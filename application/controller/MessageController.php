...
class MessageController extends Controller
{
    ...
    public function index($toUserID)
    {
        ...
        $chat = MessageModel::getAllMessagesByUser(toUserID: $toUserID);
        $this->View->render('message/index', array(
            'messages' => MessageModel::getAllMessagesByUser($toUserID),
            'receiverID' => $toUserID
        ));
    }
    ...
    {
        MessageModel::sendMessage($toUserID,Request::post('messageText'));
        Redirect::to('message/index/' . $toUserID);
    }
